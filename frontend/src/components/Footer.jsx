        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 sm:gap-12 pb-12 border-b border-white/10">
          ...
          <div className="sm:col-span-1 md:col-span-4 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {Boolean(settings?.social_links?.whatsapp?.trim()) && (
                <a href={settings.social_links.whatsapp} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/10 hover:bg-[#C97C5D] rounded-full transition-all duration-300 text-white hover:scale-110" aria-label="WhatsApp">
